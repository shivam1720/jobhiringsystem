<?php
	...
	if(isset($_POST['login']))
	{
		...
		{
				$que=mysqli_query($cn,"select *  from user_reg where name='".$uname."' and password='".$pwd."'");
...
<head>
    ...
    <title>Candidate Log In | Register </title>
    <!-- Favicon-->
...
<body class="login-page" style="background-image: url('images/back1.jpg');  background-repeat: no-repeat;
  background-size: 100% 175%;">
    <div class="login-box">
        <div class="logo">
            <a>Candidate Log In</a>
